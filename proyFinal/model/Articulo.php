...
if(isset($_GET['prueba']) && $_GET['prueba'] == 1){
        ...
        echo "creando artículo<br>";

        $art = new Articulo($CNX,2);

        var_dump($art);

        echo "Insertando artículo: <br>";
        $artnew = new Articulo($CNX,0);

        //Fijar las propiedades del artículo:
        $artnew->descripcion = "Artículo nuevo de prueba 1";
        $artnew->precio = 99.99 ;
        $artnew->stock = 100;
        $artnew->id_categoria = 2;

        //Guardar el artículo en la base de datos:
        $artnew->save();

        echo "Artículo nuevo creado: $artnew->id_articulo <br>";

        echo "Actualizando artículo: <br>";
...
if(isset($_GET['prueba']) && $_GET['prueba'] == 2){
